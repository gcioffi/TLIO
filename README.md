...
python3 src/main_net.py --mode test --root_dir data/Dataset_Overfit_Real_sure --test_list data/Dataset_Overfit_Real_sure/test.txt --model_path results/Overfit_Real_sure_MSE/checkpoints/checkpoint_18.pt --out_dir results/Overfit_Real_sure_MSE/results/network/ --imu_freq 500 --save_plot --window_time 0.5
