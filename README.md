...
- scp raceTraj18Jun21.bag user@snaga.ifi.uzh.ch:/data/storage/user/TLIO/data/rosbags 


**Create a COPY from snaga to local laptop**

- scp -r user@snaga.ifi.uzh.ch:/home/user/TLIO/results/race18June21 . 
...
A folder called "params" is generated in the directory: TLIO/src. In this folder, there are two yaml files called "dataloader_params.yaml" and "dataloader_params_snaga.yaml". If a local version of the code is used, then it is necessary to adapt dataloader_params and use it. 
It specifies the bagfile of the trajectory to analyze and the recorded topics (IMU + GT).  
Furthermore, in this config file there are also the bias values and the number of trajectories to test.
...
When launching this script, a data directory --data_dir should be specified: TLIO/data/Dataset_cpc_1_65. 

**COMMAND TO LAUNCH:**

python3 src/dataloader/gen_racing_data.py --data_dir data/Dataset_cpc_1_65/
...
python3 src/main_net.py --mode train --root_dir data/Dataset_cpc_1_65/ --train_list data/Dataset_cpc_1_65/train.txt --val_list data/Dataset_cpc_1_65/val.txt --out_dir results/Dataset_cpc_1_65/ --batch_size 128 --imu_freq 500 --imu_base_freq 500 --window_time 0.5 --epochs 100 
...
python3 src/main_net.py --mode test --root_dir data/Dataset_cpc_1_65 --test_list data/Dataset_cpc_1_65/test.txt --model_path results/Dataset_cpc_1_65/checkpoints/checkpoint_38.pt --out_dir results/Dataset_cpc_1_65/results/network/ --imu_freq 500 --imu_base_freq 500 --save_plot --window_time 0.5
...
python3 src/main_filter.py --root_dir data/Dataset_cpc_1_65 --data_list data/Dataset_cpc_1_65/test.txt --model_path results/Dataset_cpc_1_65/checkpoints/checkpoint_38.pt --model_param_path results/Dataset_cpc_1_65/parameters.json --out_dir results/Dataset_cpc_1_65/results/filter/ --update_freq 20 --initialize_with_offline_calib --erase_old_log
...
python3 plot_filter_results.py --data_dir ../data/Dataset_cpc_1_65 --data_list ../data/Dataset_cpc_1_65/test.txt --filter_dir ../results/Dataset_cpc_1_65/results/filter/
